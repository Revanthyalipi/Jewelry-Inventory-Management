...
//			$result = mysqli_query($conn,$query);
			...
			$query2 = "select j.Article_name,j.Article_weight,j.Article_type,j.Purity,oi.Quantity,oi.Discount,oi.Price from jewellery j ,order_items oi, where j.Article_id = oi.Art_id and oi.O_id = \"$id\"";
			$result = mysqli_query($conn,$query2);
